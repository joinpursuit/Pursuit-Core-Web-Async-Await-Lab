document.addEventListener("DOMContentLoaded", ()=>{
    ...
    async  function nDeck(){
    const nDeck = await axios.get("https://deckofcardsapi.com/api/deck/new/shuffle/?deck_count=1");
    const deckID = nDeck.data.deck_id;
    const remaining = nDeck.data.remaining
    ...
    async function drawCards(){
        ...
        let myDeck = await axios.get('https://deckofcardsapi.com/api/deck/' + deckID + '/draw/?count=' + cardsNumber);
